...
=======
#### [Upcoming Events](http://localhost:3000/#/upcomingevents)
Upcoming events shows all the events hosted by the clubs and gives user an option to either register for the event or see more info about the event.
>>>>>>> 370c6d5c7d126f35ee4ec0d73010e500ea015c34
...
=======
#### [Join a club](http://localhost:3000/#/joinclub)
Join a club page shows all the clubs and gives the user an option to either join the club or see more info about the club. Once they join the club, the join club option will be replaced with the option to leave.

![](/images/clubs.png)

#### [Create a club](http://localhost:3000/#/create)
Page where the user can fill out their club request to the admin where they can either approve or decline their club request

![](/images/create.png)

#### [User Profile Page](http://localhost:3000/#/profile)
User's personal profile page that shows the club user is in and events they set "interested to participate"
...
Second, visit the [Club Lounge application github page](https://github.com/club-lounge/club-lounge), and 
...
At the end of the file there is a field called "loadAssetsFile", which is set to `true`, which
means that it will read the data in the file app/private/data.json (Contains default club, event, request, and tags data)
